...
const Dashboard = () => {
    ...
    const features = [
        { title: 'Workout Plans', description: 'Find personalized workout routines.', emoji: '💪', link: '/workout' },
        { title: 'Track Progress', description: 'Monitor your fitness journey.', emoji: '📈', link: '/progress' },
        { title: 'Nutrition', description: 'Get healthy meal suggestions.', emoji: '🥗', link: '/nutrition' },
        { title: 'Goals', description: 'Set and crush your fitness goals.', emoji: '🎯', link: '/goals' },
    ];
